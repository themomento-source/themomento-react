...
function Footer() {
  ...
  return (
    <footer className="bg-black text-gray-300 py-12 md:py-16">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-start">

        {/* About The Momento */}
        <div className="md:col-span-1 space-y-4">
          <h3 className="text-white font-semibold text-lg font-marcellus">About The Momento</h3>
          <p className="text-white text-sm leading-relaxed">
           The Momento is a UK-based non-profit platform dedicated to empowering photographers across
            the globe—especially those from underrepresented and rural communities. While we are in the process 
            of becoming a registered charity, our mission is already in
            motion: helping photographers build their careers through free, professional portfolio galleries, expert 
        ...
        <div className="md:col-span-1 space-y-4">
          <h4 className="text-white font-medium font-marcellus">Opportunities We Offer</h4>
          <ul className="text-sm text-gray-white space-y-2 list-disc list-inside">
            <li>
        ...
        <div className="md:col-span-1">
          <ul className="space-y-3 text-sm font-marcellus text-white">
