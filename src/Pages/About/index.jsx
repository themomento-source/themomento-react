...
const AboutMomento = () => {
  return (
    <div className="bg-gray-50 py-16 px-4 md:px-8">
      ...
      {/* Content Section */}
      <div className="max-w-7xl mx-auto bg-white p-8 md:p-12 shadow-lg rounded-lg">
        {/* Title */}
        <h1 className="text-4xl md:text-5xl font-bold text-black mb-6 text-center font-marcellus">
          About Momento
        </h1>
        ...
        <div className="space-y-8">
          ...
          <div className="text-center">
            <p className="text-gray-600 text-base md:text-lg font-pt-serif leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-100 p-6 rounded-lg hover:shadow-md transition-shadow duration-300">
              <div className="flex justify-center mb-4">
                <FaLightbulb className="text-3xl text-[#FFCB00]" />
              </div>
            ...
            <div className="bg-gray-100 p-6 rounded-lg hover:shadow-md transition-shadow duration-300">
              <div className="flex justify-center mb-4">
                <FaGlobe className="text-3xl text-[#FFCB00]" />
              </div>
              <h3 className="text-xl font-semibold text-black mb-2 font-marcellus text-center">
                Our Vision
              </h3>
          ...
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-black mb-6 font-marcellus">
              What We Offer
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-100 p-6 rounded-lg hover:shadow-md transition-shadow duration-300">
                <div className="flex justify-center mb-4">
                  <FaCamera className="text-3xl text-[#FFCB00]" />
                </div>
              ...
              <div className="bg-gray-100 p-6 rounded-lg hover:shadow-md transition-shadow duration-300">
                <div className="flex justify-center mb-4">
                  <FaUsers className="text-3xl text-[#FFCB00]" />
                </div>
                <h3 className="text-xl font-semibold text-black mb-2 font-marcellus">
                  Global Community
                </h3>
              ...
              <div className="bg-gray-100 p-6 rounded-lg hover:shadow-md transition-shadow duration-300">
                <div className="flex justify-center mb-4">
                  <FaHandshake className="text-3xl text-[#FFCB00]" />
                </div>
                <h3 className="text-xl font-semibold text-black mb-2 font-marcellus">
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-gray-600 text-base md:text-lg font-pt-serif mb-8">
            ...
            <button className="inline-block px-8 py-3 text-lg font-semibold text-gray-900 bg-[#FFCB00] hover:bg-[#e6b800] transition-colors duration-300 rounded-lg">
              Join Now
            </button>
          </div>
        </div>
