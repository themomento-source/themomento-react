...
import { FaCamera, FaGlobe, FaLightbulb, FaUsers, FaHandshake } from "react-icons/fa"; 
  ...
  return (
    <div className="bg-gray-50 py-16 px-4 md:px-8">
      ...
      <div className="max-w-7xl mx-auto bg-white p-8 md:p-12 shadow-lg rounded-lg">
        ...
        {/* Subtitle */}
        <p className="text-black text-lg md:text-xl text-center mb-12 font-pt-serif">
        ...
        <div className="space-y-8">
          ...
          <div className="text-center">
            <p className="text-black text-base md:text-lg font-pt-serif leading-relaxed">
          ...
          <div className="text-center mt-12">
            ...
            <p className="text-black text-base md:text-lg font-pt-serif mb-8">
