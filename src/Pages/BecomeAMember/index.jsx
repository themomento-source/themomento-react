      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {/* Point 1 */}
            <div className="text-center bg-gray-900 p-6 shadow-2xl hover:shadow-lg transition-shadow duration-300">
            ...
            {/* Point 2 */}
            <div className="text-center bg-gray-900 p-6  hover:shadow-lg transition-shadow duration-300">
              <div className="flex justify-center mb-4">
